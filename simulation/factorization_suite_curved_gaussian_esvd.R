...
source_code_info <- c(source_code_info, readLines("../simulation/factorization_suite_curved_gaussian_esvd.R"))
...
rule <- function(vec){
  ...
  dat <- generator_curved_gaussian(nat_mat, vec["size"])
...
save.image("../results/factorization_results_curved_gaussian_esvd.RData")

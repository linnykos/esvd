...
source_code_info <- c(source_code_info, readLines("../simulation/factorization_suite_pcmf_esvd.R"))
...
res <- simulation::simulation_generator(rule = rule, criterion = criterion,
                                        ...
                                        filepath = "../results/factorization_results_pcmf_esvd_tmp.RData",
                                        verbose = T)

save.image("../results/factorization_results_pcmf_esvd.RData")

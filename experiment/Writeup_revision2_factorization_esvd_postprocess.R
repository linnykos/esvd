...
png(filename = "../figure/experiment/Revision_writeup2_simulation_missing_value.png",
...
png(filename = "../figure/experiment/Revision_writeup2_simulation_fit.png",
    height = 2250, width = 2250, res = 300,
    units = "px")
...
for(k in 1:4){
  png(filename = paste0("../figure/experiment/Revision_writeup2_simulation_missing_", k, ".png"),
...
for(k in 1:4){
  png(filename = paste0("../figure/experiment/Revision_writeup2_simulation_embedding_", k, ".png"),
      height = 2500, width = 2500, res = 300,
      units = "px")

...
density_func1 <- function(x,y){
  val1 <- 0.5*dmvnorm(c(x,y), mean = c(-1.5,1.5), sigma = matrix(c(1,-.5,-.5,1),2,2))
  val2 <- 0.5*dmvnorm(c(x,y), mean = c(1.5,1.5), sigma = matrix(c(2,0,0,2),2,2))
  val1 + val2
}

density_func2 <- function(x,y){
  val1 <- 0.8*dmvnorm(c(x,y), mean = c(2,0.5), sigma = matrix(c(.5,0,0,3),2,2))
  val2 <- 0.2*dmvnorm(c(x,y), mean = c(3,-1), sigma = matrix(c(.25,0,0,.25),2,2))
  val1 + val2
}
...
png("../figure/theory/3_before.png", height = 1200, width = 2000, res = 300, units = "px")
par(mfrow = c(1,2))
...
png("../figure/theory/3_after.png", height = 1200, width = 2000, res = 300, units = "px")
par(mfrow = c(1,2))

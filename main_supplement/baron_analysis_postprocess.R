rm(list=ls())
load("../results/baron_analysis.RData")

num_datasets <- length(preprocessing_list)
...
#   png(filename = paste0("../../esvd_results/figure/experiment/Revision_writeup4_baron_embedding_", i, ".png"),
...
# testing
for(i in 1:num_datasets){
  png(filename = paste0("../../esvd_results/figure/experiment/Revision_writeup4_baron_test_", i, ".png"),
      height = 3000, width = 4000, res = 300,
      units = "px")
...
# training
for(i in 1:num_datasets){
  png(filename = paste0("../../esvd_results/figure/experiment/Revision_writeup4_baron_train_", i, ".png"),
      height = 3000, width = 4000, res = 300,
      units = "px")
  par(mfrow = c(3,4))
  dat <- preprocessing_list[[i]]$dat_impute

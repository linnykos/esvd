...
.evaluate_objective.neg_binom <- function(dat, u_mat, v_mat, r, ...){
...
.evaluate_objective_single.neg_binom <- function(dat_vec, current_vec, other_mat, n, p, r, ...){
...
.gradient_vec.neg_binom <- function(dat_vec, current_vec, other_mat, n, p, r, ...){
  stopifnot(length(current_vec) == ncol(other_mat), nrow(other_mat) == length(dat_vec))
...
.evaluate_objective_mat.neg_binom <- function(dat, pred_mat, r, ...){
...
.gradient_mat.neg_binom <- function(dat, pred_mat, r, ...){
  stopifnot(all(dim(dat) == dim(pred_mat)))

...
ylim <- range(dat_impute[missing_idx])
...
lines(1000*cos(theta_seq), 1000*sin(theta_seq), lwd = 1.5, lty = 2)
text(1000,200, labels = paste0(round(naive_angle*180/pi,1), " degrees"), pos = 4)
...
lines(1000*cos(theta_seq), 1000*sin(theta_seq), lwd = 1.5, lty = 2)
text(1000,200, labels = paste0(round(our_angle*180/pi,1), " degrees"), pos = 4)
graphics.off()

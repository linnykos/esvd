...
plot(statements[[3]], pch = 16, col = rgb(0,0,0,0.5), xlab = "Singular value position", ylab = "Value", xlim = c(1,20))
```
...
```{r, echo = F}
set.seed(10)
idx <- sample(1:nrow(statements[[6]]), 50000)
plot(statements[[6]][idx,1], statements[[6]][idx,2], pch = 16, xlab = "Predicted mean",
     ylab = "Residual")
...
```{r, echo = F}
plot(statements[[10]][,1], statements[[10]][,2], pch = 16, xlab = "V[,1]", ylab = "V[,2]", col = rgb(0,0,0,0.1))
...
set.seed(10)
idx <- sample(1:nrow(statements[[6]]), 50000)
plot(statements[[11]][idx,1], statements[[11]][idx,2], pch = 16, xlab = "mean",
...
for(i in 1:7){
  ...
  plot(res$u[idx,1], res$u[idx,2], pch = 16, main = level_vec[i],
       xlim = xrange, ylim = yrange, xlab = "U[,1]", ylab = "U[,2]")
  lines(c(-10,10), c(0,0), col = "red", lwd = 2)
  lines(rep(-.02, 2), c(-10,10), col = "red", lwd = 2)
}
```
...
```{r, echo = F}
plot(res$v[,1], res$v[,2], pch = 16, xlab = "V[,1]", ylab = "V[,2]", col = rgb(0,0,0,0.1))
lines(rep(0,2), c(-10,10), col = "red", lwd = 2)
lines(c(-10,10), rep(0,2), col = "red", lwd = 2)
```
...
```{r, echo = F}
set.seed(10)
idx <- sample(1:prod(dim(mat)), 50000)
